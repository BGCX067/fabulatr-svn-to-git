...
//<![CDATA[
	...
	var checkStarted  = /^(.*)Your server is shutdown(.*)$/;
	...
	function check_server() {
		...
		if (!instanceStarted){
			$.get("/check_server_stop?keysig=" + keysig, function(data){ 
				$("#starting").html(data);
			});
...
<form class="wufoo topLabel" enctype="multipart/form-data" method="post" action="/stop">

<div class="info">
<h2>EC2 Fabulatr</h2>
<p>This page will update until your instance is shutdown.  In the meantime, you may want to look around and see if someone is watching you start and stop instances like a mad man.</p>
